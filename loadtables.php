...
function loaddocumentlistfortraining($docttype_value)
{
        include 'dbconfig.php'; 
        @$username = $_COOKIE['usname'];
                    ...
                    if(!mysqli_error($sqlcon))
                    {
                        if(mysqli_num_rows($dbt)!=0)
                        {
                            while($rows = mysqli_fetch_assoc($dbt))
                            {
                                ...
                                @$trainingcenter = $rows['trainingcenter']; 
                                @$issuedate = $rows['datestart']; 
                                @$expirydate = $rows['dateend']; 
                                @$classheader = "";
                                if($authenticity=="")
                                {
                                ...
                                echo "<div class='col-md-4' style='margin-top:10px;'>"; 
                                        echo "<div class='card border border-primary'>";                        
                                                ...
                                                echo "<div class='card-body'>";
                                                    ...
                                                    echo "  <p class='card-title text-dark'>Training Center - <span id='trainingcenter_$id' class='text-primary'>$trainingcenter</span></p>";
                                                    echo "  <p class='card-title text-dark'>Date Start (DD/MM/YYYY)- <span id='datestart_$id' class='text-primary'>$issuedate</span></p>";
                                                    echo "  <p class='card-text text-dark'>Date End (DD/MM/YYYY)- <span id='dateend_$id' class='text-primary'>$expirydate</span></p>";
...
function loaddocumentlistforforeign($docttype_value)
{
        include 'dbconfig.php'; 
        @$username = $_COOKIE['usname'];
        @$mydoctype = $docttype_value; 
                            ...
                            while($rows = mysqli_fetch_assoc($dbt))
                            {
                                ...
                                echo "<div class='col-md-4' style='margin-top:10px;'>"; 
                                        echo "<div class='card border border-primary'>";                        
                                                ...
                                                echo "<div class='card-body'>";
                                                    echo "  <p class='card-title text-dark'>Docu/Cert No - <span id='docnumber_$id' class='text-primary'>$docnumber</span></p>";
                                                    echo "  <p class='card-title text-dark'>Country - <span id='country_$id' class='text-primary'>$country</span></p>";
                                ...
                                if($doctype=='Training')
                                {
                                    ...
                                    echo "<div class='card-header  $classheader'>";
                                        ...
                                        if($authenticity!="Verified")
                                        {
                                            ...
                                            echo "<div class='card-body'>";
                                        echo "  <p class='card-title text-dark'>Docu/Cert No - <span id='docnumber_$id' class='text-primary'>$docnumber</span></p>";
                                        echo "  <p class='card-title text-dark'>Trainingcenter - <span id='trainingcenter_$id' class='text-primary'>$trainingcenter</span></p>";
                                        echo "  <p class='card-title text-dark'>Date Start (DD/MM/YYYY)- <span id='datestart_$id' class='text-primary'>$datestart</span></p>";
                                        echo "  <p class='card-text text-dark'>Date End (DD/MM/YYYY)- <span id='dateend_$id' class='text-primary'>$dateend</span></p>";
                                        echo "  <p class='card-text text-dark'>Status: <span id='status_$id'>$authenticity</span></p>";
