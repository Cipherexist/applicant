...
<script src="https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js"></script>
  ...
  <script>
        ...
        function newshow(myid,mytitle,myposition,mycaption,mydescription)
        {
          $("#loading").show();
        ...
        function applicationshow(myid,mytitle,myposition)
        {
          $("#loading").show();
      
      
          /*
          var therank = $("#mycurrentrank").val(); 
          var reqrank = myposition; 
          Swal.fire({
          icon: 'error',
          title: 'Your Rank:' + reqrank,
          text: 'Something went wrong!',
          footer: '<a href="">Why do I have this issue?</a>'
        });
        */

          document.getElementById('jobtitle').innerHTML = mytitle; 
          document.getElementById('jobtitleid').value = myid; 
          var theid = $("#jobtitleid").val(); 

          $.post("application_browse.php",
          {
            idme: theid
          },function(result)
          {
        ...
        function popupwindow(thefunction,thehiringid,theuser)
        {
          ...
          },function(result)
          {
            ...
            if(result==1)
            {
              ...
              window.location.replace("quizmode.php","windowName", "width=4000,height=4000,scrollbars=yes");
              /*
                let tID = setTimeout(function () {

                // redirect page.
                window.location.href = 'quizmode.php';
        ...
        function submitnotif(thehiring,theuser,thestatus)
        {
          var hiring = thehiring; 
         var userme = theuser; 
         var status = thestatus; 
         var remarks = $("#confirmremarks").val(); 


        $.post("application_confirmappointment.php",
        {
          myhiring: hiring, 
          myusername: userme, 
          mystatus: status, 
        ...
        {
          $("#appointmenttab").empty();
            $("#appointmenttab").append(result); 
        ...
        function submitnotifupload(thehiring,theuser)
        {
          $("#ajaxloadingupload").show();
          document.getElementById("btn-submitupload").disabled = true ;

         var hiring = thehiring; 
         var userme = theuser; 


         $.post("application_submitdocsave.php",
         {
          myhiring: hiring, 
          myusername: userme
         },function(result)
...
<div class="row">
          <ul class="nav nav-tabs">
                <li class="nav-item">
                  <a class="nav-link " href="application.php" aria-current="page">Find New Jobs</a>
                </li>
                <li class="nav-item">
